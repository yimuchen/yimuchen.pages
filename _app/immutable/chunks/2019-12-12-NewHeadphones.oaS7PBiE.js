import{s as $,n as N}from"./scheduler.D8jTWijz.js";import{S as ee,i as te,e as o,s as l,c as a,g as s,a as h,b as B,d as n,f as i}from"./index.MdRYwpiI.js";function ne(Z){let r,U='<ol class="toc-level toc-level-1"><li class="toc-item toc-item-h2"><a class="toc-link toc-link-h2" href="#choosing-the-headphone">Choosing the headphone</a></li><li class="toc-item toc-item-h2"><a class="toc-link toc-link-h2" href="#my-current-experience">My current experience</a></li><li class="toc-item toc-item-h2"><a class="toc-link toc-link-h2" href="#open-questions-and-closing-words">Open questions and closing words</a></li></ol>',C,m,D=`When travelling on the plane to and from Geneva back in November, I noticed
...
headphones.`,I,u,z='<a aria-hidden="true" tabindex="-1" href="#choosing-the-headphone"><span class="icon icon-link"></span></a>Choosing the headphone',_,c,W=`Noise-cancelling headphones have been on my tech-news radar for a while. I know
...
Bose any Sony line up.`,M,g,K=`Noise-cancelling is not the only thing to consider when a headset. How a set of
...
to trust the Sennheiser brand, to went for the Sennheiser Momentum 3.`,T,d,F='<a aria-hidden="true" tabindex="-1" href="#my-current-experience"><span class="icon icon-link"></span></a>My current experience',q,f,G=`First and foremost, I don’t have the budget to tryout headphone on a regular
...
have no way of comparing, so no more comments on sound quality.`,H,w,J=`The noise-cancelling capability is as tested: decent/OK. The loudest source of
...
all, the noise-cancelling is doing its job.`,S,y,V=`[Update 2019-12-30] On my plane ride back to Taiwan, the noise-cancelling is
...
my using habits.`,A,b,X=`Now for a random story. When operating in wired mode, whether USB or the 3.5 mm
...
solving.`,P,v,E=`[Update 2019-12-30] Another peculiar episode occurred when attempting to
...
has since been fixed using <a href="https://wiki.archlinux.org/index.php/PulseAudio/Troubleshooting#Setting_the_default_fragment_number_and_buffer_size_in_PulseAudio" rel="nofollow">pulseaudio settings</a>, but just note that
this is yet another issue that one might need to deal with.`,L,p,Q='<a aria-hidden="true" tabindex="-1" href="#open-questions-and-closing-words"><span class="icon icon-link"></span></a>Open questions and closing words',j,x,R=`[Update 2019-12-30] There is a strange bug that after the firmware update of
...
smart gestures or headphone interfaces).`,O,k,Y=`All in all, I would say I am happy with the overall experience, but at the same
...
working with the product what I paid a considerable amount to buy.`;return{c(){r=o("nav"),r.innerHTML=U,C=l(),m=o("p"),m.textContent=D,I=l(),u=o("h2"),u.innerHTML=z,_=l(),c=o("p"),c.textContent=W,M=l(),g=o("p"),g.textContent=K,T=l(),d=o("h2"),d.innerHTML=F,q=l(),f=o("p"),f.textContent=G,H=l(),w=o("p"),w.textContent=J,S=l(),y=o("p"),y.textContent=V,A=l(),b=o("p"),b.textContent=X,P=l(),v=o("p"),v.innerHTML=E,L=l(),p=o("h2"),p.innerHTML=Q,j=l(),x=o("p"),x.textContent=R,O=l(),k=o("p"),k.textContent=Y,this.h()},l(e){r=a(e,"NAV",{class:!0,"data-svelte-h":!0}),s(r)!=="svelte-1s3r4zm"&&(r.innerHTML=U),C=h(e),m=a(e,"P",{"data-svelte-h":!0}),s(m)!=="svelte-1c145js"&&(m.textContent=D),I=h(e),u=a(e,"H2",{id:!0,"data-svelte-h":!0}),s(u)!=="svelte-10io6vf"&&(u.innerHTML=z),_=h(e),c=a(e,"P",{"data-svelte-h":!0}),s(c)!=="svelte-cgagij"&&(c.textContent=W),M=h(e),g=a(e,"P",{"data-svelte-h":!0}),s(g)!=="svelte-cxbpdp"&&(g.textContent=K),T=h(e),d=a(e,"H2",{id:!0,"data-svelte-h":!0}),s(d)!=="svelte-7uhobb"&&(d.innerHTML=F),q=h(e),f=a(e,"P",{"data-svelte-h":!0}),s(f)!=="svelte-17yyrox"&&(f.textContent=G),H=h(e),w=a(e,"P",{"data-svelte-h":!0}),s(w)!=="svelte-10ix7s3"&&(w.textContent=J),S=h(e),y=a(e,"P",{"data-svelte-h":!0}),s(y)!=="svelte-1jrzm9p"&&(y.textContent=V),A=h(e),b=a(e,"P",{"data-svelte-h":!0}),s(b)!=="svelte-1a5caqd"&&(b.textContent=X),P=h(e),v=a(e,"P",{"data-svelte-h":!0}),s(v)!=="svelte-18pmkmo"&&(v.innerHTML=E),L=h(e),p=a(e,"H2",{id:!0,"data-svelte-h":!0}),s(p)!=="svelte-jpw9uq"&&(p.innerHTML=Q),j=h(e),x=a(e,"P",{"data-svelte-h":!0}),s(x)!=="svelte-1kz3ty"&&(x.textContent=R),O=h(e),k=a(e,"P",{"data-svelte-h":!0}),s(k)!=="svelte-rw18iv"&&(k.textContent=Y),this.h()},h(){B(r,"class","toc"),B(u,"id","choosing-the-headphone"),B(d,"id","my-current-experience"),B(p,"id","open-questions-and-closing-words")},m(e,t){n(e,r,t),n(e,C,t),n(e,m,t),n(e,I,t),n(e,u,t),n(e,_,t),n(e,c,t),n(e,M,t),n(e,g,t),n(e,T,t),n(e,d,t),n(e,q,t),n(e,f,t),n(e,H,t),n(e,w,t),n(e,S,t),n(e,y,t),n(e,A,t),n(e,b,t),n(e,P,t),n(e,v,t),n(e,L,t),n(e,p,t),n(e,j,t),n(e,x,t),n(e,O,t),n(e,k,t)},p:N,i:N,o:N,d(e){e&&(i(r),i(C),i(m),i(I),i(u),i(_),i(c),i(M),i(g),i(T),i(d),i(q),i(f),i(H),i(w),i(S),i(y),i(A),i(b),i(P),i(v),i(L),i(p),i(j),i(x),i(O),i(k))}}}const ae={title:"Sennheiser Momentum 3 - My thoughts",description:"Initial thoughts on my new headphones after purchase",tags:["hardware","thoughts"]};class se extends ee{constructor(r){super(),te(this,r,null,ne,$,{})}}export{se as default,ae as metadata};
