...
compatible).</p></li>`,fe,j,mt=`Ultimately, the solution that I am looking for is a distribution agnostic
...
exceeds what I was hoping for.`,ve,u,yt='<a aria-hidden="true" tabindex="-1" href="#nix-as-a-portable-package-manager"><span class="icon icon-link"></span></a><code>nix</code> as a portable package manager',ge,B,ft=`The <a href="https://nixos.org/" rel="nofollow"><code>Nix</code> package manager</a> (and its accompanying Linux distribution
...
with.`,Pe,w,It='<a aria-hidden="true" tabindex="-1" href="#setting-up-home-manager"><span class="icon icon-link"></span></a>Setting up home-manager',je,R,At=`The nix-specific <a href="https://nix-community.github.io/home-manager/" rel="nofollow"><code>home-manager</code> package</a> is originally designed
...
effectively all the packages we are interested in.`,Be,J,Pt=`Because channel support is still incomplete with nix-portable, you need to
...
<span class="line"><span style="color:#88846F">## create ~/.config/home-manager/flake.nix</span></span></code></pre></div>`,Oe,K,Bt=`Following this, you should have access to the <code>home-manager</code> command, where you
